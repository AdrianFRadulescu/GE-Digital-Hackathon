...
date    = urllib.parse.quote_plus(list(sys.argv)[1])
lat     = urllib.parse.quote_plus(list(sys.argv)[2])
lng     = urllib.parse.quote_plus(list(sys.argv)[3])

# Call our function.
url_data = get_url('data.police.uk', '/api/crimes-at-location?date='+ date + '&lat=' + lat + '&lng=' + lng)
